...
class StripePaymentController extends Controller
{
     ...
     *     description="Creates a Stripe PaymentIntent for high-value transfers using card payments and fee collection",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"amount", "description", "user_id"},
     *             @OA\Property(property="amount", type="integer", minimum=1000000, example=1000000, description="Amount in cents (minimum $10,000)"),
     *             @OA\Property(property="description", type="string", example="High-value transfer", description="Payment description"),
     *             @OA\Property(property="user_id", type="string", example="user_123", description="User identifier"),
     *             @OA\Property(property="currency", type="string", example="usd", description="Payment currency"),
     *             @OA\Property(property="receipt_email", type="string", format="email", description="Email for receipt")
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
     ...
     *             @OA\Property(property="client_secret", type="string", description="Client secret for frontend confirmation"),
     *             @OA\Property(property="payment_intent_id", type="string", example="pi_1234567890", description="Payment intent ID"),
     *             @OA\Property(property="amount", type="integer", description="Amount in cents"),
     *             @OA\Property(property="status", type="string", example="requires_payment_method", description="Payment status"),
     *             @OA\Property(property="transaction_id", type="integer", description="Internal transaction ID")
     *         )
     *     ),
     *     @OA\Response(
     *         response=400,
